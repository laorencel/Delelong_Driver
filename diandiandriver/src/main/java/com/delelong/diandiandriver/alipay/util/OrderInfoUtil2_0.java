...
import com.delelong.diandiandriver.alipay.SignUtils;
...
public class OrderInfoUtil2_0 {
	...
	public static Map<String, String> buildOrderParamMap(String app_id) {
		...
		String sum = "0.01";
		String title = "测试账号";
		String biz_content = "{\"timeout_express\":\"7d\",\"product_code\":\"QUICK_MSECURITY_PAY\",\"total_amount\":\"_SUM_\",\"subject\":\"_TITLE_\",\"body\":\"我是测试数据\",\"out_trade_no\":\"" + getOutTradeNo() +  "\"}";
		biz_content = biz_content.replace("_SUM_",sum).replace("_TITLE_",title);
